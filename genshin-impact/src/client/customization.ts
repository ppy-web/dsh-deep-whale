...
const ATTR_ART = 'data-dsh-whale-genshin-art'
const ATTR_FONT = 'data-dsh-whale-genshin-font'
const ATTR_MODEL_EXIT = 'data-dsh-whale-genshin-model-exit'
const ATTR_MODEL = 'data-dsh-whale-model'
const ATTR_FLASH_GLASSES = 'data-dsh-whale-genshin-flash-glasses'
const ATTR_COMPOSER_MODE = 'data-genshin-composer-mode'
const ATTR_NAV_MODE = 'data-genshin-nav-mode'
...
export function installGenshinCustomization(root: HTMLElement = document.documentElement): () => void {
  ...
  return exposeSkinCustomization({
    ...
    skinId: 'genshin-impact',
    title: '提瓦特旅者',
    titleEn: 'Teyvat Traveler',
    settings: [
      {
        key: 'artwork',
        type: 'boolean',
        label: '显示元素旅者立绘',
        labelEn: 'Show the elemental traveler artwork',
        defaultValue: true,
      },
      {
        key: 'sfwMode',
